...
requiredGroupSize = int(input("Enter required groud size? "))

group = numberOfStudent // requiredGroupSize
leftOver = numberOfStudent % requiredGroupSize

if group <= 1 and leftOver <= 1:
    print(f"There will be {group} group with {leftOver} student left over.")

elif group <= 1 and leftOver > 1:
    print(f"There will be {group} group with {leftOver} students left over.")

elif group > 1 and leftOver > 1:
    print(f"There will be {group} groups with {leftOver} students left over.")

elif group > 1 and leftOver <= 1:
    print(f"There will be {group} groups with {leftOver} student left over.")

else:
    print("Invalid Group and left over Students")